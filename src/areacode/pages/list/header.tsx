...
export function MAAreaCodeHeader({
  info,
  displayParam,
  setDisplayParam,
}: {
  info: HeaderInfo
  displayParam: string[]
  setDisplayParam: React.Dispatch<React.SetStateAction<string[]>>
}) {
  ...
  return (
    <div className={MAList.maAreaCodeHeader}>
      <div className={MAList.headerContainer}>
        <div className={MAList.mainHeader}>
          ...
          {info.mainHeaderLink && (
            <a
              className={MAList.mainHeaderLink}
              href={info.mainHeaderLink}
              target="blank"
            >
              Google Mapで見る
            </a>
