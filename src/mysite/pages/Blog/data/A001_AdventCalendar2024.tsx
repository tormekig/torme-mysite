  ...
  return (
    <div className={blog.articleContent}>
      ...
      <p>
        私はこれまでのIT経験を活かして、
        <br />
        エンジニア視点の記事を書いてみようと思います。
        <br />
        結果的にQiita風の記事になりつつありますが、
        <br />
        それもまたいいですよねということで。
      </p>
      <p>
      ...
      <p>
        先ほどからお世話になっているChatGPTを、
        <br />
        実は結構すでに個人的に活用していたりします。
      </p>
      <p>
        うちには「ささめ」という
        <br />
