        ...
        <div className={mysite.socialMediaContentContainer}>
          <div className={`${mysite.socialMediaContent} ${mysite.youtube}`}>
            ...
            <div className={mysite.socialMediaFooter}>
              <a href="https://www.youtube.com/@torme_kig" className={mysite.socialMediaAuthor} target="_blank" rel="noreferrer">
              ...
              <a href="https://www.youtube.com/@torme_kig" className={`${mysite.socialMediaButton} ${mysite.youtube}`} target="_blank" rel="noreferrer">
                アカウントへ
              </a>
            </div>
          </div>
        ...
        <div className={mysite.socialMediaContentContainer}>
          <div className={`${mysite.socialMediaContent} ${mysite.instagram}`}>
            ...
            <div className={`${mysite.socialMediaFooter} ${mysite.instagram}`}>
              <a href="https://www.instagram.com/sasame0123/" className={mysite.socialMediaAuthor} target="_blank" rel="noreferrer">
                <div className={`${mysite.socialMediaIconContainer} ${mysite.instagram}`}>
                  <img src="./img/instagram-icon.jpg" />
                </div>
                <div>sasame0123</div>
              </a>
              <a href="https://www.instagram.com/sasame0123/" className={`${mysite.socialMediaButton} ${mysite.instagram}`} target="_blank" rel="noreferrer">
                アカウントへ
              </a>
            </div>
          </div>
              ...
              <div className={mysite.socialMediaMain}>
                ...
                <div>
                  ...
                  <div className={`${mysite.socialMediaFooter} ${mysite.x}`}>
                    <a href="https://twitter.com/torme_kig" className={mysite.socialMediaAuthor} target="_blank" rel="noreferrer">
                    ...
                    <a href="https://twitter.com/torme_kig" className={`${mysite.socialMediaButton} ${mysite.x}`} target="_blank" rel="noreferrer">
                      アカウントへ
                    </a>
                  </div>
                </div>
              ...
              <div className={mysite.socialMediaMain}>
                ...
                <div>
                  <div>
                    ...
                    />
                    <div className={`${mysite.socialMediaFooter} ${mysite.x}`}>
                      <a href="https://twitter.com/torme_etc" className={mysite.socialMediaAuthor} target="_blank" rel="noreferrer">
                      <div className={`${mysite.socialMediaIconContainer} ${mysite.x}`}>
                          <img src="https://pbs.twimg.com/profile_images/1550079970617487362/cNeFJAF5_400x400.jpg" />
                        </div>
                        <div>@torme_etc</div>
                      </a>
                      <a href="https://twitter.com/torme_etc" className={`${mysite.socialMediaButton} ${mysite.x}`} target="_blank" rel="noreferrer">
                        アカウントへ
                      </a>
                    </div>
                  </div>
